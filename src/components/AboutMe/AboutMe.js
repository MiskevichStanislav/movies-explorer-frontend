                ...
                <div className="about-me__wrapper">
                    <div className="about-me__description">
                        ...
                        <ul className="about-me__links">
                            <li><a className="about-me__link" href="https://https://vk.com/miskevichstasik">Вконтакте</a></li>
                            <li><a className="about-me__link" href="https://github.com/MiskevichStanislav">Github</a></li>
                        </ul>
                    </div>
